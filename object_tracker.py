...
#################################################################################
        ...
        for track1 in tracker.tracks:
            ...
            class_name1 = track1.get_class()
            if not class_name1 == 'person':
                continue
            ...
            for track2 in tracker.tracks:
                ...
                if class_name2 != 'person':
                    continue
                print("{} ------ {} -------- {} -------- {}/{}".format(bbox1, bbox2, overlap(bbox1, bbox2), track1.track_id, track2.track_id))
            ...
            if flag == 'green':
                ...
                cv2.rectangle(img, (int(bbox[0]), int(bbox[1]-30)), (int(bbox[0])+(len(class_name)+len(str(track.track_id)))*17, int(bbox[1])), (0, 0, 255), -1)
                cv2.putText(img, class_name + "-" + str(track.track_id),(int(bbox[0]), int(bbox[1]-10)),0, 0.75, (255,255,255),2)
